...
// 校准全局变量与校准状态（新增）
extern QMC5883L_Calib_t g_qmc5883l_calib;
extern volatile bool mag_calibrating;
extern volatile uint32_t mag_calib_tick;
#define MAG_CALIB_DURATION_MS 3000  // 30秒校准
...
#define QMC5883L_I2C_PORT		&hi2c2
